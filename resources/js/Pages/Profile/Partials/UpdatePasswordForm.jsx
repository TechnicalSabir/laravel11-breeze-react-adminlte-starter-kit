                    ...
                    <div className="col-md-6">
                        <div className="mb-3">
                            ...
                            <div className="input-group">
                                <input ref={currentPasswordInput} type="password" className="form-control password_input" placeholder="Current Password" value={data.current_password} onChange={(e) => setData('current_password', e.target.value)} />
                        ...
                        <div className="form-group">
                            ...
                            <input ref={passwordInput} type="password" className="form-control password_input" value={data.password} onChange={(e) => setData('password', e.target.value)} />
                            {errors.password && <span className='pl-1 m-0 text-danger text-sm'>{errors.password}</span>}
                        </div>
                        <div className="form-group">
                            <label>Confirm Password</label>
                            <input ref={passwordInput} type="password" className="form-control password_input" value={data.password_confirmation} onChange={(e) => setData('password_confirmation', e.target.value)} />
